          ...
          <swiper class="swiper art-artist-swiper" :options="swiperOption" ref="mySwiper">
            ...
            >
              <div class="art-artist-box">
                ...
                <div :ref="`text${index}`" v-html="artist.text" class="art-artist-head-text"></div>
                <div class="art-artist-btn-box">
                  <img @click="scrollText(index)" class="art-artist-btn" src="@/assets/img/index/book-btn.png" alt="btn">
                </div>
              </div>
            </swiper-slide>
          </swiper>
...
export default {
  ...
  data () {
    return {
      ...
      artists: [
        ...
        //     積極在亞太地區推廣多元立體紙藝的臺灣團隊，除了與新加坡、香港等跨國合作外，更是第一個同時榮獲臺灣立體書專利、臺灣文博會百大新銳獎、華人公益獎等殊榮的紙藝公司。近年與國立故宮博物院、玉珍齋、奇美博物館、臺灣博物館、衛武營國家藝術文化中心...等推出聯名商品，為臺灣紙藝品牌與公民營機構跨界共創立下里程碑。
        //   `,
        // },
      ]
    }
  ...
  methods: {
    scrollText(index) {
      this.$nextTick(() => {
        let scrollTopIndex = this.$refs[`text${index}`][0]
        scrollTopIndex.scrollTop = scrollTopIndex.scrollTop + 50
      })
    }
  },
  watch: {
